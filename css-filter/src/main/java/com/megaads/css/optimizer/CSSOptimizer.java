...
public class CSSOptimizer {
    ...
    private final Set<String> htmlFiles = new HashSet<String>();
    private final String targetFilePath;
    private final String resultFilePath;
    private String fileContent;

    private final Set<String> usedClassNames = new HashSet<String>();
    private final Set<String> usedTagNames = new HashSet<String>();

    private int cssStyleRulesCount = 0;
    private int removedCssStyleRulesCount = 0;
    

    public int getCssStyleRulesCount() {
		return cssStyleRulesCount;
	}


	public int getRemovedCssStyleRulesCount() {
		return removedCssStyleRulesCount;
	}
    ...
    public CSSOptimizer(String fileContent)
    {
    ...
    public String buildResult(List<CSSRule> cssRules) {
        StringBuilder retVal = new StringBuilder();
